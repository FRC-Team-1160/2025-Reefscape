...
public class SwervePIDController {
    ...
    public ChassisSpeeds calculate() {
        ...
        double desired_ang_speed = ang_pid_controller.atSetpoint() ? 0 : RobotUtils.clampAbs(ang_pid_controller.calculate(robot_pose.getRotation().getRadians()), Tracking.MAX_ANG_SPEED);
        desired_ang_speed = current_speeds.omegaRadiansPerSecond
         + RobotUtils.clampAbs(desired_ang_speed - current_speeds.omegaRadiansPerSecond, Tracking.MAX_ANG_ACCEL * RobotConstants.LOOP_TIME_SECONDS);
